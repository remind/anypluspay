 ...
 */
@Configuration
@MapperScan(basePackages = {"com.anypluspay.payment.infra.persistence.mapper", "com.anypluspay.admin.payment.dao.mapper"}, sqlSessionFactoryRef = "paymentSqlSessionFactory")
public class PaymentDataSourceConfigure {
    ...
    public SqlSessionFactory sqlSessionFactory(@Qualifier("paymentDataSource") DataSource dataSource, MybatisPlusInterceptor mybatisPlusInterceptor) throws Exception {
